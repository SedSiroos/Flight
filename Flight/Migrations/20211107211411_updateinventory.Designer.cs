...
namespace Flight.Migrations
{
    ...
    [Migration("20211107211411_updateinventory")]
            ...
            modelBuilder.Entity("Flight.Entity.Domain.AirLine", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2021, 11, 8, 0, 44, 10, 414, DateTimeKind.Local).AddTicks(5604),
                            Name = "ملکی ایرلاین"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2021, 11, 8, 0, 44, 10, 414, DateTimeKind.Local).AddTicks(7337),
                            Name = "ایران ایر"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2021, 11, 8, 0, 44, 10, 414, DateTimeKind.Local).AddTicks(7368),
                            Name = "ماهان"
                        });
                });
            ...
            modelBuilder.Entity("Flight.Entity.Domain.Airplane", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2021, 11, 8, 0, 44, 10, 418, DateTimeKind.Local).AddTicks(2687),
                            Name = "C130"
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2021, 11, 8, 0, 44, 10, 418, DateTimeKind.Local).AddTicks(5580),
                            Name = "فوکر 100"
                        },
                        new
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2021, 11, 8, 0, 44, 10, 418, DateTimeKind.Local).AddTicks(5622),
                            Name = "هواپیمای تستی"
                        });
                });
            ...
            modelBuilder.Entity("Flight.Entity.Domain.City", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2021, 11, 8, 0, 44, 10, 399, DateTimeKind.Local).AddTicks(293),
                            Name = "تهران"
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2021, 11, 8, 0, 44, 10, 406, DateTimeKind.Local).AddTicks(2148),
                            Name = "مشهد"
                        },
                        new
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2021, 11, 8, 0, 44, 10, 406, DateTimeKind.Local).AddTicks(2255),
                            Name = "رشت"
                        },
                        new
                        {
                            Id = 4,
                            CreatedOn = new DateTime(2021, 11, 8, 0, 44, 10, 406, DateTimeKind.Local).AddTicks(2269),
                            Name = "اهواز"
                        });
                });
