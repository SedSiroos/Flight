...
namespace Flight.Migrations
{
    ...
    [Migration("20211106150829_AddTable")]
            ...
            modelBuilder.Entity("Flight.Entity.Domain.AirLine", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2021, 11, 6, 18, 38, 28, 949, DateTimeKind.Local).AddTicks(1582),
                            Name = "ملکی ایرلاین"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2021, 11, 6, 18, 38, 28, 949, DateTimeKind.Local).AddTicks(2695),
                            Name = "ایران ایر"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2021, 11, 6, 18, 38, 28, 949, DateTimeKind.Local).AddTicks(2714),
                            Name = "ماهان"
                        });
                });
            ...
            modelBuilder.Entity("Flight.Entity.Domain.Airplane", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2021, 11, 6, 18, 38, 28, 949, DateTimeKind.Local).AddTicks(4541),
                            Name = "C130"
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2021, 11, 6, 18, 38, 28, 949, DateTimeKind.Local).AddTicks(5539),
                            Name = "فوکر 100"
                        },
                        new
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2021, 11, 6, 18, 38, 28, 949, DateTimeKind.Local).AddTicks(5558),
                            Name = "هواپیمای تستی"
                        });
                });
            ...
            modelBuilder.Entity("Flight.Entity.Domain.City", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2021, 11, 6, 18, 38, 28, 944, DateTimeKind.Local).AddTicks(1960),
                            Name = "تهران"
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2021, 11, 6, 18, 38, 28, 947, DateTimeKind.Local).AddTicks(5140),
                            Name = "مشهد"
                        },
                        new
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2021, 11, 6, 18, 38, 28, 947, DateTimeKind.Local).AddTicks(5189),
                            Name = "رشت"
                        },
                        new
                        {
                            Id = 4,
                            CreatedOn = new DateTime(2021, 11, 6, 18, 38, 28, 947, DateTimeKind.Local).AddTicks(5196),
                            Name = "اهواز"
                        });
                });
